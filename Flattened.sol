...
// File contracts/BrusmaxPunksDNA.sol

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.9;

contract BrusmaxPunksDNA{
...
// File contracts/BrusmaxPunks.sol
...
contract BrusmaxPunks is ERC721, ERC721Enumerable, BrusmaxPunksDNA {
  ...
  constructor(uint256 _maxSupply) ERC721("BrusmaxPunks", "MXPKS"){
  ...
  function mint() public {
    ...
    require(current < maxSupply, "No BrusmaxPunks left :(");
  ...
  returns (string memory)
  {
    ...
    string memory jsonURI = Base64.encode(
      abi.encodePacked(
        '{ "name": "BrusmaxPunks #',
        tokenId.toString(),
        '", "description": "Brusmax Punks are randomized Avatars stored on chain to teach DApp development on Platzi",',
        '"image":"',
        image,
        '}'
      ));
